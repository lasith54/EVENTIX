...
@router.post("/{event_id}/pricing", response_model=EventPricingTierResponse, status_code=status.HTTP_201_CREATED)
...
@router.put("/pricing/{pricing_id}", response_model=EventPricingTierResponse)
